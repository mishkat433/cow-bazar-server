...
router.get('/:id', (0, auth_1.default)(userEnums_1.USER_ROLE.admin, userEnums_1.USER_ROLE.buyer, userEnums_1.USER_ROLE.seller), user_controller_1.userController.getSingleUserHandler);
