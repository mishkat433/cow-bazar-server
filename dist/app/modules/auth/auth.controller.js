...
const loginUserHandler = (0, catchAsync_1.default)((req, res, next) => __awaiter(void 0, void 0, void 0, function* () {
...
const refreshTokenHandler = (0, catchAsync_1.default)((req, res, next) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    const result = yield auth_services_1.authServices.refreshToken(refresh_token);
